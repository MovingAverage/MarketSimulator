...
# 	DONE - Test for merging stop orders
# 	DONE - Test for cancelling stop orders
# 	DONE - Store closed orders for day instead of data.frame of transactions
# 	DONE - Make sure position uses current size to sell if target is zero
